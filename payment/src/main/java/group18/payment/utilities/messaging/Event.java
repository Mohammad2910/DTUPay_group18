...
public class Event implements Serializable {
	...
	public <T> T getArgument(int i, Class<T> cls) {
		...
		// of an group18.payment.utilities.messaging.impl.Event, LinkedTreeLists are returned, which cannot be
		...
		// This also works, for tests, where the arguments to an group18.payment.utilities.messaging.impl.Event contain
